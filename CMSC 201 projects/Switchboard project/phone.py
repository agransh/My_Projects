...
class Phone:
    ...
    def connect(self, area_code, other_phone_number):
        ...
        """
        if area_code is None or other_phone_number is None:
            return None
        else:
            return self.connect(area_code, other_phone_number)
    ...
    def disconnect(self):
        ...
        """
        ph = Phone(number=121, switchboard=443)
        return ph.connect(area_code=443,other_phone_number=121)
