...
class Mario: public Character {
 public:
  ...
  virtual bool SpecialMove(int, int);
  // Name: GetType
  ...
  virtual bool IsSpecialMoveAvailable(int,int);
  virtual void SetLastTurnSM(int);
  virtual int GetLastTurnSM();
  private:
  //Last time Mario used his Special Move
  int lastTurnSM=-10;
};
#endif
